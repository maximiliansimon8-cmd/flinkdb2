    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium border transition-all duration-150 ${
        active
          ...
          : 'bg-slate-800/40 text-slate-400 border-slate-700/40 hover:bg-slate-800/60 hover:text-slate-300'
      }`}
    >
      <config.icon size={12} />
      {config.label}
      ...
      {hasMore && (
        <div className="text-center mt-6 mb-4">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-800/60 border border-slate-700/50 text-base font-medium text-slate-300 hover:bg-slate-800/80 hover:border-slate-600/50 hover:text-slate-200 transition-all duration-200"
          >
            <ChevronDown size={14} />
