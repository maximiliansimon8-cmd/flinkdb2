...
import InspectionApp from '../src/components/InspectionApp.jsx'

// Error boundary for standalone Inspection App
class InspectionErrorBoundary extends Component {
  constructor(props) { super(props); this.state = { hasError: false, error: null }; }
  static getDerivedStateFromError(error) { return { hasError: true, error }; }
  componentDidCatch(error, info) { console.error('[InspectionApp Crash]', error, info?.componentStack); }
  render() {
      ...
      return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif', background: '#f8fafc' }}>
          <div style={{ textAlign: 'center', maxWidth: 480, padding: 24 }}>
            ...
            <h1 style={{ fontSize: 18, fontWeight: 600, color: '#0f172a', marginBottom: 8 }}>Protokollpruefung konnte nicht geladen werden</h1>
...
createRoot(document.getElementById('inspection-root')).render(
  <StrictMode>
